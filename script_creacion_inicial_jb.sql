...
BEGIN
	...
	RETURN (SELECT COUNT(*) 
		   ...
		   WHERE Chofer_Telefono = @Telefono);
...
BEGIN
	...
	SET NOCOUNT ON;
		...
		--CONTROLA QUE NO EXISTA UNA FACTURACION REALIZADA EN EL MISMO MES PARA EL CLIENTE, EN CASO DE EXISTIR, SE CANCELA LA FACTURACION.
